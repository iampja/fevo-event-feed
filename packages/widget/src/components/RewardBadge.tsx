...
function RewardIcon({ type }: { type: RewardType }) {
  switch (type) {
    ...
    case 'custom':
      return (
        <svg class="fevo-ef-rw-badge-icon" viewBox="0 0 24 24" fill="currentColor">
          <path d="M9.5 9.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm4.09-3.59L12 6.32l-1.59 1.59L12 9.5l1.59-1.59zM12 14.5l-1.59 1.59L12 17.68l1.59-1.59L12 14.5zm5-2.5c0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2-2 .9-2 2zM3 12c0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2-2 .9-2 2zm11.5-2.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 5c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" />
        </svg>
      );
  }
}
